...
class celularAltaGama extends Celular {
    ...
    infoAltaGama() {
      return this.mobileInfo() + `Resolucion de camara extra: <b>${this.resolucionDeCamaraExtra}</b><br><br>`
    }
}

// const celular1 = new Celular ('rojo', '150g', '5 Pulgadas', 'full hd', '2gb')
// const celular2 = new Celular ('blanco', '157g', '5.9 Pulgadas', 'hd', '4gb')
// const celular3 = new Celular ('verde', '155g', '5.45 Pulgadas', 'mega hd', '7gb')
...
// document.write(celular2.mobileInfo() + '<br>')
// document.write(celular3.mobileInfo())
const celular1 = new celularAltaGama ('Cafe', '200g', '6.7p', '10px', '8gb', 'full hdsisima')
const celular20 = new celularAltaGama ('Cafesito', '200g', '4.7', '17px', '14gb', 'pelle')
